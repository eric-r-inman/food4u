...
diets =
    [ { name = "Mediterranean"
      , staples =
            [ "Extra-virgin olive oil", "Chickpeas", "Lentils", "Farro", "Whole-wheat pasta", "Tomatoes", "Garlic", "Onions", "Spinach", "Lemons", "Olives", "Almonds", "Walnuts", "Greek yogurt", "Feta", "Canned sardines" ]
      }
    , { name = "Blue Zone"
      , staples =
            [ "Black beans", "Chickpeas", "Fava beans", "Brown rice", "Oats", "Whole-grain corn tortillas", "Sweet potato", "Cabbage", "Kale", "Garlic", "Onions", "Tofu", "Miso", "Walnuts", "Extra-virgin olive oil", "Green tea" ]
      }
    , { name = "MIND"
      , staples =
            [ "Blueberries", "Strawberries", "Kale", "Spinach", "Romaine", "Oats", "Quinoa", "Whole-grain bread", "Brown rice", "Black beans", "Lentils", "Walnuts", "Almonds", "Extra-virgin olive oil", "Salmon", "Chicken" ]
      }
    , { name = "DASH"
      , staples =
            [ "Oats", "Brown rice", "Whole-grain bread", "Black beans", "Kidney beans", "Lentils", "Banana", "Oranges", "Apples", "Spinach", "Broccoli", "Carrots", "Sweet potato", "Greek yogurt", "Almonds", "Chicken" ]
      }
    , { name = "Anti-Inflammatory"
      , staples =
            [ "Turmeric", "Ginger", "Cinnamon", "Garlic", "Extra-virgin olive oil", "Salmon", "Canned sardines", "Blueberries", "Tart cherries", "Kale", "Spinach", "Broccoli", "Walnuts", "Flaxseed", "Chia seeds", "Green tea" ]
      }
    ]
